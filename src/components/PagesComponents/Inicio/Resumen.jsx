...
export default function Resumen({ deben, debo, valorDeben, valorDebo }) {
    return (
        <section className=" flex flex-col justify-start p-4 gap-3 w-12/12 m-auto">
            ...
            <Button name='Liesta de préstamo' style='border border-slate-900 border-[1px] w-50 p-2  m-auto rounded-md text-sm font-semibold' />
